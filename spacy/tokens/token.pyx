...
from ..attrs cimport IS_OOV, IS_TITLE, IS_UPPER, IS_CURRENCY, LIKE_URL, LIKE_NUM, LIKE_EMAIL, IS_ORG
...
cdef class Token:
    ...
    property is_org:
        """RETURNS (bool): Whether the token is a org component."""
        def __get__(self):
            return Lexeme.c_check_flag(self.c.lex, IS_ORG)
